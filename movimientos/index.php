...
if (isset($_GET['subserieVacias'])) {
    $_SESSION['subserieFiltrado'] = $_GET['subserieVacias'];
    $subserieFiltrado = $_SESSION['subserieFiltrado'];
    echo "<script>window.location='index.php'</script>";
}
$subserieFiltrado = $_SESSION['subserieFiltrado'];
...
<div class="container1">
    <div class="scroll">
        ...
        <?php
            ...
            */
            ...
            if (!$_GET) {
                echo "<script>window.location='index.php?pagina=1'</script>";
            }
            /*
            PAGINACION
        ...
        <tr>
            ...
            <td><a href="../HADES/consultor/inventarioGeneral.php?fondoFiltrado=<?php echo $mostrar['empresa'];?>&dependenciaFiltrado=<?php echo $mostrar['dependencia'];?>&serieFiltrado=<?php echo $mostrar['serie'];?>&numCajaFiltrado=<?php echo $mostrar['num_Caja'];?>&pagina=1" target="_blank"><?php echo $mostrar['num_Caja'];?> </a></td>
    ...
    <div class="pagination">
        <ul>
            ...
            -->
            <li class="page-item"><a class="btn btn-outline-light mx-2" href="index.php?pagina=<?php if($pagina != 1){ echo $pagina - 1;} else { echo 1;}?>">Anterior</a></li>
            <li class="page-item"><a class="btn btn-outline-light mx-2" href="index.php?pagina=<?php if($pagina != $maxPag){ echo $pagina + 1;} else { echo $maxPag;}?>">Siguiente</a></li>
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-2" aria-labelledby="dropdownMenuLink">
                    <div>
                        ...
                        */
                        ...
                        ?>
                        <li>
                            <a href="index.php?pagina=<?php echo $i;?>" class="btn <?php if($i == $pagina){ echo "btn-primary";}?>"><?php echo $i;?></a>
                        </li>
                        <?php
                        $i++;
                        }
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-2" aria-labelledby="dropdownMenuLink">
                    <div>
                        <a href="index.php?pagina=<?php echo 1;?>&regxpag=10" class="btn <?php if(isset($_SESSION['reg_x_pag'])){if($_SESSION['reg_x_pag'] == 10){ echo "btn-primary";}}?>">10</a>
                        <a href="index.php?pagina=<?php echo 1;?>&regxpag=20" class="btn <?php if(isset($_SESSION['reg_x_pag'])){if($_SESSION['reg_x_pag'] == 20){ echo "btn-primary";}}?>">20</a>
                        <a href="index.php?pagina=<?php echo 1;?>&regxpag=50" class="btn <?php if(isset($_SESSION['reg_x_pag'])){if($_SESSION['reg_x_pag'] == 50){ echo "btn-primary";}}?>">50</a>
                    </div>
                </div>
            </div>
        </ul>
