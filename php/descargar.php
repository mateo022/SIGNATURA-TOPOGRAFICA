...
define("DB_USER", 'root');
define("DB_PASSWORD", '');
define("DB_NAME", 'loginsigsoft');
define("DB_HOST", 'localhost');
define("BACKUP_DIR", 'backup-signatura'); // Comment this line to use same script's directory ('.')
...
?>
<br><br><br>
<a href="../index.php" style="text-decoration:none; padding:20px; background:#000; border-radius:20px; color:#fff;">Finalizado</a>
