...
if (isset($_GET['estanteFiltrado'])) {
    ...
    echo "<script>window.location='AgregarColab.php'</script>";
}
...
<div class="container1">
    <div class="scroll">
        <table class="table">
            ...
            <th>
                ...
                <div class="dropdown-menu p-2" aria-labelledby="dropdownMenuLink">
                    <form action="AgregarColab.php" method="GET" class="form-group">
            ...
            <th class="text-white">CODIGO QR</th>
                ...
                <div class="dropdown-menu p-2" aria-labelledby="dropdownMenuLink">
                    <form action="AgregarColab.php" method="POST" class="form-group">
        ...
        <?php
            ...
            */
            ...
            if (!$_GET) {
                echo "<script>window.location='AgregarColab.php?pagina=1'</script>";
            }
            /*
            PAGINACION
            ...
            */
            ...
            $idCount = mysqli_fetch_assoc($executeSelectCount);
            $maxPag = ceil($idCount['id'] / $reg_x_pag);
        ...
        <tr>
            ...
            <td><?php echo $mostrar['lado'];?></td>
            <td><?php echo $mostrar['entrepano'];?></td>
            <td><?php echo $mostrar['posicion'];?></td>
            <td><?php echo $mostrar['dependencia'];?></td>
            <td><?php echo $mostrar['serie'];?></td>
            <td><?php echo $mostrar['subserie'];?></td>
            <td><a href="../../HADES/consultor/php/puenteSignatura.php?fondo=<?php echo $mostrar['empresa'];?>&dependencia=<?php echo $mostrar['dependencia'];?>&serie=<?php echo $mostrar['serie'];?>&numCaja=<?php echo $mostrar['num_Caja'];?>&pagina=1" target="_blank"><?php echo $mostrar['num_Caja'];?> </a></td>
    ...
    <div class="pagination">
        <ul>
            ...
            -->
            <li class="page-item"><a class="btn btn-outline-light mx-2" href="AgregarColab.php?pagina=<?php if($pagina != 1){ echo $pagina - 1;} else { echo 1;}?>">Anterior</a></li>
            <li class="page-item"><a class="btn btn-outline-light mx-2" href="AgregarColab.php?pagina=<?php if($pagina != $maxPag){ echo $pagina + 1;} else { echo $maxPag;}?>">Siguiente</a></li>
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-2" aria-labelledby="dropdownMenuLink">
                    <div>
                        ...
                        */
                        ...
                        ?>
                        <li>
                            <a href="AgregarColab.php?pagina=<?php echo $i;?>" class="btn <?php if($i == $pagina){ echo "btn-primary";}?>"><?php echo $i;?></a>
                        </li>
                        <?php
                        $i++;
                        }
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-2" aria-labelledby="dropdownMenuLink">
                    <div>
                        <a href="AgregarColab.php?pagina=<?php echo 1;?>&regxpag=10" class="btn <?php if(isset($_SESSION['reg_x_pag'])){if($_SESSION['reg_x_pag'] == 10){ echo "btn-primary";}}?>">10</a>
                        <a href="AgregarColab.php?pagina=<?php echo 1;?>&regxpag=20" class="btn <?php if(isset($_SESSION['reg_x_pag'])){if($_SESSION['reg_x_pag'] == 20){ echo "btn-primary";}}?>">20</a>
                        <a href="AgregarColab.php?pagina=<?php echo 1;?>&regxpag=50" class="btn <?php if(isset($_SESSION['reg_x_pag'])){if($_SESSION['reg_x_pag'] == 50){ echo "btn-primary";}}?>">50</a>
                    </div>
                </div>
            </div>
        </ul>
